  ...
  return (
    <div className="bg-[#cbdad4]">
      ...
      <FadeAcademySection
        ...
        description="Formatoare la Fade Academy Mioveni, este recunoscuta pentru abilitatea sa de a inspira si de a ghida viitorii frizeri catre succes. Cu o experienta vasta in domeniu si o atentie deosebita la tendintele actuale, ea transforma fiecare cursant intr-un profesionist sigur pe sine, capabil sa abordeze orice provocare in hairstyling. Prin cursurile sale bine structurate, [Nume Formator] isi propune sa ofere fiecarui participant un parcurs clar si complet in frizerie, pregatindu-i atat pentru munca intr-un salon, cat si pentru a-si deschide propria afacere."
      />
      <PriceContact
        price="2000 RON"
